        ...
        <div class="container" style="height: 100%;">
            <div class="row justify-content-center align-items-center" style="height: 100%;">
                <div class="col-12 col-sm-8 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title text-center">Registrar no Click Chama</h4>
                            <form action="{{route('auth.seller.register')}}">
                                <div class="row justify-content-center">
                                    <div class="col-10 mb-2"><label class="form-label">Nome Completo</label><input type="text" class="form-control" name="name"></div>
                                    ...
                                    <div class="col-10 mb-2"><label class="form-label">Senha</label><input type="password" class="form-control" name="confirm_password"></div>
                                    <div class="col-10 mb-2"><button class="btn btn-primary btn-send" type="button" style="width: 100%;">CADASTRAR</button></div>
                                </div>
                            </form>
                        </div>
                    </div>
